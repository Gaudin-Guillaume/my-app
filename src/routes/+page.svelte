...
<section id="hero" class="flex flex-col md:flex-row justify-between items-center">

	<div class="w-4/12 gap-4 flex flex-col">
		<div class=" text-4xl font-semibold">
			M2i Group - Des solutions de biocontrôle pour une  <br>agriculture durable
		</div>
	...
	<video autoplay loop muted class=" h-full max-w-">
...
<section class="flex flex-col md:flex-row gap-4 md:gap-32 my-32 md:my-0 px-4 md justify-center items-center align-center h-fit md:h-screen ">
	...
	<div class="flex flex-col md:flex-row justify-end ">
    	<img src="./first.png" alt="produit de biocontrole " class="w-96" >
    </div>
...
<section class=" flex flex-col justify-around items-center align-center  w-screen p-4 h-fit md:h-screen gap-8" style="background-color:rgba(23, 89, 87, 0.1)">
	<div class="flex flex-col gap-4 justify-center w-screen px-4 md:p-32">
		<div class="text-2xl font-semibold text-left ">Quelques chiffres à propos de notre activités.</div>
...
<div class="flex flex-col md:flex-row gap-8">
	<div class="card flex:col p-4 space-y-4 w-96">
		...
		<div class="font-thin text-6xl">22k</div>
	...
	<div class="card flex:col p-4 space-y-4 w-96">
		...
		<div class="font-thin text-6xl">200</div>
		<span class="text-xl font-thin" style="color:#15514F">Collaborateurs</span>
	...
	<div class="card flex:col p-4 space-y-4 w-96">
		...
		<div class="font-thin text-6xl">80</div>
